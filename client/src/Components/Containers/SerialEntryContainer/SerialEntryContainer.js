  ...
  render() {
    ...
    return (
      <div className="card entry-container">
        <p className="serial-entry-title">{this.props.serial.title}</p>
        <p className="serial-entry-synopsis">{this.props.serial.synopsis}</p>
        <div className="serial-entry-options">
          {this.props.serial &&
          this.props.clientUser &&
          this.props.clientUser._id === this.props.serial.author_id ? (
            <Fragment>
              <Link
                className="button button--primary serial-entry-option-item"
                to={`/serials/${this.props.serial._id}/new`}>
                {" "}
                New Part{" "}
              </Link>
              <button
                ...
                className="button button--danger serial-entry-option-item">
                Delete
              </button>
            </Fragment>
          ) : null}
          <Link
            className="button button--positive serial-entry-option-item"
            to={`/serials/${this.props.serial._id}`}>
            Read It
          </Link>
          {this.props.clientUser ? (
            <button
              ...
              className="button is-disabled serial-entry-option-item">
              {subscribeButtonText}
            </button>
          ) : null}
        </div>
